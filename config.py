...
BOT_TOKEN = getenv("BOT_TOKEN", "8148738737:AAEPzFMhiNYpN8r1xJahqpqj5LUgqgpmje0")
...
LOG_GROUP = getenv("LOG_GROUP", "4728154864")
CHANNEL_ID = int(getenv("CHANNEL_ID", "1002526570060"))
